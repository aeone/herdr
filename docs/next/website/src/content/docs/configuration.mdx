...
`remote_host` renders in its own accent colour so a mirrored machine reads as distinct from the workspace name beside it. Give it an inline `fg` to pick your own:
