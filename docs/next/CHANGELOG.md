...
- A pane that has not been laid out yet is guessed at the size of the screen rather than 80x24. A mirror pane is created at this guess and asks its host to render at it, and a host does what it is asked -- so on a machine whose panes are 70 rows tall, every handoff that rebuilt the mirrors briefly asked their hosts for 24 rows, shrinking real terminals on the other machine and reflowing their output before the pane was laid out and the guess corrected.
