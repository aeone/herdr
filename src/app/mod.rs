...
fn agent_panel_sort_from_config(
    ...
    match sort {
        ...
        crate::config::AgentPanelSortConfig::Status => state::AgentPanelSort::Status,
    }
}
...
impl App {
    ...
    pub fn new(
        ...
        crate::detect::set_shell_rules(&config.agent_detection.shell_rules);
    ...
    fn handle_non_terminal_key_headless(&mut self, key: crate::input::TerminalKey) {
        ...
        match self.state.mode {
            ...
            Mode::KeybindHelp => match self.state.keybind_help_mirrors_key(key_event) {
                ...
                None => input::handle_keybind_help_key(&mut self.state, key),
            },
            Mode::GlobalMenu => {
