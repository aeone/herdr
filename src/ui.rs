...
use self::menus::{
    ...
    render_jump_overlay, render_navigate_overlay, render_prefix_overlay, render_resize_overlay,
};
use self::mobile::{
...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        AgentPanelRow, WorkspaceListEntry,
    },
};
...
pub fn render_with_runtime_registry(
    ...
    match app.mode {
        ...
        Mode::Jump => render_jump_overlay(app, frame, mode_bar_area),
