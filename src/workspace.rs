    ...
    pub fn new_streamed_mirror(
        ...
        Ok((
            Self {
                ...
                // A mirror stands for a pane on another machine, so the git
                // identity of whatever directory it was opened in here means
                // nothing -- and discovering it would be filesystem work per
                // mirror, on every handoff that rebuilds them.
